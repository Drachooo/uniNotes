...
% Definire: A, vettore riga che contiene i numeri pari da 2 fino a 20
A = 2:2:20  % start:step:end (inizio da 2, salto di 2, finisco a 20)

% Definire: B, vettore riga con tutti i numeri da -22 a -13
B = -22: -13

% Definire: C, vettore riga con 10 valori uguali a 0. 
