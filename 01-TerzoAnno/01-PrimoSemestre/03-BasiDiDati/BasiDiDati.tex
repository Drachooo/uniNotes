...
\begin{document}
  ...
  \begin{description}
    ...
    Ne consegue che le variazioni dello shcema logico (purchè non vengano rimossi dati) non impattano sugli schemi esterni e quindi sulle applicazioni (eventualmente è necessario solo ridefinire l'espressione di derivazione).
  \end{description}
  ...
  Un attrivuto con cardinalità massima N viene detto \textbf{attributo multivalore} e devono essere utilizzati con cautela, perchè rappresentano situazioni che possono essere modellate, in alcune occasioni, in modo più appropriato mediante l'introduzione di nuove entità e relazioni.
