...
Il risultato dell‘interrogazione è una tabella con una riga per ogni riga prodotta dalla clausola $\verb|FROM|$ ed, eventualmente, filtrata dalla clausola $\verb|WHERE|$, le cui colonne dipendono dalla lista degli attributi nella clausola $\verb|SELCET|$.
...
\begin{esempiobox}{Interrogazione con \texttt{SIMILAR TO}}
  ...
  \smallskip
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/tabella-studenti-similarTo.png}
  \end{center}
...
\begin{esempiobox}{Interrogazione con \texttt{BETWEEN}}
  ...
  \smallskip
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/tabella-studenti-between.png}
  \end{center}
...
\begin{esempiobox}{Interrogazione con \texttt{IN}}
  ...
  \smallskip
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/tabella-studenti-in.png}
  \end{center}
...
\begin{esempiobox}{Interrogazione con \texttt{IS NULL}}
  ...
  \smallskip
  $\boldsymbol{\mathrm{Q_9}}$\textbf{: estrarre tutti gli studenti che hanno matricola nell'elenco 'IN0001', 'IN0003' e 'IN0005'}
  \begin{sqlcode}
    SELECT cognome, nome, città
    FROM Studente
      WHERE città IS NULL;  
...
\begin{esempiobox}{Interrogazione con \texttt{DISTINCT}}
  ...
  \smallskip
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/tabella-persona.png}
  \end{center}
...
\begin{esempiobox}{Interrogazione con utilizzo di \texttt{AS}}
  ...
  \smallskip
  $\boldsymbol{\mathrm{Q}}$\textbf{: estrarre tutti gli impiegati che hanno lo stesso cognome, ma nome diverso del dipartimento Produzione}
  \begin{sqlcode}
...
\begin{esempiobox}{Interrogazione con \texttt{ORDER BY}}
  ...
  \smallskip
  $\boldsymbol{\mathrm{Q}}$\textbf{: estrarre il nome, l'età e il reddito delle persone con meno di 30 anni in ordine alfabetico}
...
\begin{esempiobox}{Interrogazione con \texttt{ORDER BY}}
  ...
  \smallskip
  $\boldsymbol{\mathrm{Q}}$\textbf{: estrarre il contenuto della tabella Automobile ordinato in base alla marca (discendente) e al modello}
