...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{images/gestore-affidabilità.png}
\end{figure}
...
\begin{itemize}[label=$\triangleright$]
  ...
  \begin{itemize}[label=$\diamond$]
    \item $B(T)$: begin della transazione
    \item $C(T)$: commit della transazione
    \item $A(T)$: abort della transazione
  \end{itemize}
  \medskip
